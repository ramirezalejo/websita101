...
import ResponsivePlayer from '../components/Multimedia/ResponsivePlayer'
...
export default function Landing() {
  return (
    <>
      <Navbar transparent />
      <main>
        <ResponsivePlayer url='https://www.youtube.com/watch?v=gNtJ4HdMavo'/>
        <div className="relative flex content-center items-center justify-center min-h-screen-60">
          <div
              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <h1 className="text-white font-semibold text-5xl">
                    Your presence online starts here.
                  </h1>
                  <p className="mt-4 text-lg text-gray-300">
                    This is a simple example of a Landing Page we can build for you. It features multiple components based
